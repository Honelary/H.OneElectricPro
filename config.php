...
define('DB_USER', 'root');             // Database username (default is 'root' for local development)
define('DB_PASS', '');                 // Database password (empty for local XAMPP/WAMP)
define('DB_NAME', 'electrician_website'); // Database name
